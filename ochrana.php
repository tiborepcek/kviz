...
<head>
	...
	<title>Prosím, zadajte heslo:</title>
</head>
<body>
	<div class = "centrovane">
		<form method="post">
			<h3>Prosím, zadajte heslo:</h3>
			<?php echo '<span class = "dolezite">' . $error_msg . '</span>'; ?><br />
			<?php if (USE_USERNAME) echo 'Meno:<br /><input type="input" name="access_login" /><br />Heslo:<br />'; ?>
...
if (isset($_POST['access_password'])) {
	...
	if (!USE_USERNAME && !in_array($pass, $LOGIN_INFORMATION) || (USE_USERNAME && (!array_key_exists($login, $LOGIN_INFORMATION) || $LOGIN_INFORMATION[$login] != $pass))) {
		showLoginPasswordProtect("Nesprávne heslo");
	} else {
